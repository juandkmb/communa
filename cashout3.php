        ...
        <div class="text-center row">
          <div class="col-md-10 col-md-offset-1">
            ...
            <div class="row">
              <div class="col-md-12">
                <h2>Thank You</h2>
                <img src="images/reward-8.png" style="padding:1em 0;" alt="">
                <p>Please check your email for your eGift Card!</p>
              </div>
            </div>

            <div class="row">
              <div class="col-md-12">
                <button class="mighty-collect-btn btn" onclick="location.href = '/communa/lobby.php';">Back to Lobby</button></p>
              </div>
            </div>
